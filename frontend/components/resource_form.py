...
def render_resource_form(fields, values=None, readonly=True):
    ...
    for field in fields:
        ...
        if "component" in field and callable(field["component"]):
            ...
            form_items.append(field["component"](readonly=readonly, value=values.get(field["id"], None)))
            continue
        ...
        if field_type == "dropdown":
            form_items.append(html.Div([
                ...
                dcc.Dropdown(
                    ...
                    value=values.get(field_id, None),
                    placeholder=field.get("placeholder", ""),
                    className=class_name,
                    disabled=readonly,
                )
